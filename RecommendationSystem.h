...
#define MIN_MULT_VALUE (-2)
struct map_comperator
{
    bool operator()(const sp_movie& sp1, const sp_movie& sp2) const
    {
      return (*sp1 < *sp2);
    }
};
...
//	explicit RecommendationSystem(){};
     ...
     * @param os the stream
     * @param system Recommendation system object
     * @return a stream
     */
 ...
 private:
  std::map<sp_movie, std::vector<double>, map_comperator> _movies;
};
